...
// This is Bang-Bang Control. It is fast but rather inaccurate
bool BangBang(double error, pros::MotorGroup obj) {
  bangExit = false;
  // this is the "Bang-Bang" Portion
  // If the arm is not within a range of the target, it sends full voltage to
  // the arm
  if (error > 500) {  // Checks if outside of Bang-Bang Exit Range (pid kicks in
